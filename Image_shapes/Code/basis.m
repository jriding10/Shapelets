...
hermites_n = load('~/Dropbox/Documents/Shapelets/Common/hermite_coeffs.txt', '-ascii');
% coords = load('../Text/HydraA_coords.txt', '-ascii');
% shapes = load('../Text/HydraA_paras.txt', '-ascii');
% beta(1) = shapes(3)/60*pi/180;
% beta(2) = shapes(4)/60*pi/180;
% n_max = 25;
